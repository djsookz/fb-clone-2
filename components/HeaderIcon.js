function HeaderIcon({ Icon, active, hidden }) {
  return (
    <div
    ...
    >
      <Icon
        ...
        } ${hidden && "hidden sm:flex xl:hidden"}`}
      />
      <span
        className={`${
          active &&
          "absolute border-[2px] bottom-[-8px]  w-28 border-blue-500 sm:left-[-6px] sm:w-10 md:left-[14px]  lg:w-20 xl:w-28 xl:left-[0px]"
        } `}
      ></span>
    </div>
  );
