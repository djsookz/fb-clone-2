    ...
    <div className="sticky top-0 z-50 bg-white flex items-center p-2  lg:px-5 shadow-md justify-between">
      ...
      <div>
        <div className="flex  items-center ">
          ...
          <MenuIcon className="h-7 pl-4 text-gray-500 place-items-start sm:hidden" />
        </div>
      </div>
      ...
      <div className="hidden sm:inline-flex justify-center flex-grow">
        <div className="flex space-x-6 md:space-x-2">
          ...
          <HeaderIcon Icon={MenuIcon} hidden />
        </div>
      </div>
      {/* Right */}
      <div className="flex items-center sm:space-x-2  ">
        <div className="hidden xl:flex  items-center space-x-2 hover:bg-gray-100 rounded-2xl">
          <Image
            onClick={signOut}
